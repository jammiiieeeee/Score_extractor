...
### Bug Fixes
- **PDF crop**: `PdfService.create_pdf()` now crops images using `config.default_crop_ratio` (top portion only). Users can regenerate PDF with different crop ratios without re-extracting.
