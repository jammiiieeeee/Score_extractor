...
class ScoreConfig:
    ...
    bar_padding_px: int = -15                    # B overlay offset from bar left edge (positive = extend into bar, negative = retract before bar)
    bar_left_margin: float = 0.35                # Left spike must be within this fraction (0-1) of frame width
